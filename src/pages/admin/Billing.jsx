 ...
 * Admin Billing Page
 *
 * Handles consultation billing from the admin perspective.
  ...
  const handleFetchReceipt = async (e) => {
    ...
    try {
      ...
      if (err.response?.status === 404) {
        setReceipt(null);
        toast('No payment found for this appointment. Use "Record Payment" below.', { icon: 'ℹ️' });
      } else {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <h3 className="text-base font-bold text-slate-800 mb-4">Search by Appointment ID</h3>
      ...
      {/* No receipt found — Process Payment */}
